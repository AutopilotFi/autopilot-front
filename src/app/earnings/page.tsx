...
const getEarningsData = () => {
  ...
  const portfolioPositions = [
    { asset: 'USDC' as const, protocol: 'morpho' as const, balance: 460000.0, apy: 9.03 },
    { asset: 'ETH' as const, protocol: 'morpho' as const, balance: 77.5, apy: 2.11 },
    { asset: 'cbBTC' as const, protocol: 'morpho' as const, balance: 0.4, apy: 4.27 },
  ];
...
export default function Home() {
  ...
  return <EarningsPage earningsData={earningsData} />;
}
