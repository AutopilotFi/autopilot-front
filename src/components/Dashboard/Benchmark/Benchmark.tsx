                            ...
                            <div className="flex items-center space-x-3">
                              ...
                              <div>
                                <div className="flex items-center space-x-2">
                                  <h4 className={`font-semibold ${item.isAutopilot ? 'text-purple-900' : 'text-gray-900'}`}>
                                    {item.name}
                                  </h4>
                                  {item.isAutopilot && (
                                ...
                                <p className={`text-sm ${item.isAutopilot ? 'text-purple-700' : 'text-gray-600'}`}>
                                  {item.description}
                                </p>
                              </div>
                            </div>
                            <div className="text-right">
                              <div className={`font-bold ${item.isAutopilot ? 'text-[#9159FF]' : 'text-gray-900'}`}>
                                {item.apy.toFixed(2)}%
                              </div>
