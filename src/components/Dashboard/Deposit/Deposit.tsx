        ...
        <div className="space-y-6">
            ...
            <div className="w-full lg:w-[60%] bg-white rounded-xl p-6 border border-gray-100">
                ...
                <div className="mb-6 p-4 bg-purple-50 border border-purple-200 rounded-lg">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-purple-700">You need to deposit {currentProjectData.asset} first before you can withdraw.</p>
                    </div>
                    </div>
                </div>
                )}
            ...
            <div className="w-full lg:w-[40%] space-y-6">
                ...
                <div className="space-y-3 text-sm">
                    ...
                    <span className="font-medium">{depositAmount || '0.00'} {currentProjectData.asset}</span>
                    </div>
                    <div className="flex justify-between">
                    <span className="text-gray-600">Current APY</span>
                    <span className="font-medium text-green-600">{(currentProjectData.currentAPY * 100).toFixed(2)}%</span>
                    </div>
                    ...
                    <div className="border-t border-gray-100 pt-3 space-y-3">
                        ...
                        <span className="font-medium text-green-600 tabular-nums">
                            +{(parseFloat(depositAmount || '0') * currentProjectData.currentAPY).toLocaleString('en-US', {
                            minimumFractionDigits: currentProjectData.asset === 'USDC' ? 2 : 6,
                            maximumFractionDigits: currentProjectData.asset === 'USDC' ? 2 : 6
                            })} {currentProjectData.asset}
                        </span>
