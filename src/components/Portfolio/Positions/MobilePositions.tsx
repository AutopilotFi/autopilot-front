...
import { PortfolioData, ProjectKey } from '@/types/globalAppTypes';
          ...
          >
            <div className="p-4">
              ...
              <div className="space-y-2 mb-3">
                {vaultsData[mobileTooltipOpen].allocations.map((vault, vIndex) => (
                  <div key={vIndex} className="flex justify-between items-center text-sm">
                    <span className="text-gray-300 mr-4">{vault.name}</span>
                    <span className="text-white font-medium">{vault.allocation}%</span>
                  </div>
                ))}
              </div>
